...
// Функция для создания новой строки на основе существующей
...
// Функция для уничтожения строки и освобождения памяти
...
// Функция для изменения размера строки с заполнением новым символом
...
// Функция для очистки строки и освобождения памяти
...
// Функция для вставки подстроки в строку на заданную позицию
